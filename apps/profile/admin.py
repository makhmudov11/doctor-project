...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ('username', 'full_name', 'user', 'followers_count', 'slug', 'following_count', 'posts_count', 'is_private')
...
class StoryAdmin(admin.ModelAdmin):
    list_display = ['id', 'profile', 'content_type', 'view_count', 'expires_at', 'is_expired_display']
